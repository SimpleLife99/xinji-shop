  ...
  <div class="info">
    ...
    <div class="main-info">
        ...
        <div class="info-introduce">
            <img v-for="n in 2" src="https://i8.mifile.cn/v1/a1/3ad7ef9b-3566-54a7-e1d0-61ff926ff44f.webp?w=1080&h=1664&bg=21282C" alt="">
        </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 检车商品是否被已经收藏过了  
    async checkCart(){
      let check = await this.$http.post({ url: "/cart/checkCart", token: this.$utils.encrypt({ userid: this.userInfo.id, shopid: this.shopid }) });
